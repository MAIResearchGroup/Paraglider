...
%     Cd  = ret(4);
%%    Вывод результатов    
    res = [interp1(palpha, pCy,  angle);...
           interp1(palpha, pCx,  angle);...
           interp1(palpha, pCmA, angle);...
           interp1(palpha, pCd,  angle)]; %LinearInterp
end
